  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">I3</a>
        ...
        <div class="row">
            <div class="jumbotron col-6 mx-auto mt-5">
                <h1 class="display-4">Create New Product</h1>
                <form>
                <div class="form-group">
                    <label for="categoryName">Product Name</label>
                    <input type="text" class="form-control mt-2" id="categoryName" placeholder="Enter Product name">
                </div>
