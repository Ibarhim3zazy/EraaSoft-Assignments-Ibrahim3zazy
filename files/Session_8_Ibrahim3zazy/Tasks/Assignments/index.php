...
<div class="container mt-5">
    ...
    <?php 
        $searchSubjects = ['difference between DROP, TRUNCATE, DELETE', 'what is the meaning of (CRUD)', 'self join', 'difference about join and union', 'Indexing and Indexing types in database'];
    ?>
    <tbody>
